...
$(".search-btn").click(function(e) {
 ...
 ///////// **creams-section** /////////
 var screen2 = new Swiper(".creams-slider .swiper-container", {
  loop: true,
  autoplay: true,
  pagination: {
    el: ".creams-slider .swiper-pagination",
    clickable: true,
  },
  navigation: {
    nextEl: ".creams-slider .swiper-btn-next",
    prevEl: ".creams-slider .swiper-btn-prev",
  },
  breakpoints: {
    0: {
      slidesPerView: 2,
...
/////////////////// oils slider //////////////////
 ...
 var screen2 = new Swiper(".oils-slider .swiper-container", {
  loop: true,
  autoplay: true,
  pagination: {
    el: ".oils-slider .swiper-pagination",
    clickable: true,
  },
  navigation: {
    nextEl: ".oils-slider .swiper-btn-next",
    prevEl: ".oils-slider .swiper-btn-prev",
  },
  breakpoints: {
    0: {
      slidesPerView: 2,
